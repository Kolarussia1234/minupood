		 ...
		 ?>
			 <div class="elementor-image-hotspots">
				 <?php foreach ( $instance['icon_list'] as $item ) : ?>
					 ...
					 $tooltipLinkTarget = 'target="_blank"';


					 if ($item['type'] == 'custom'){
						 $tooltipText = $item['text_content'];
						 $tooltipLink = $item['link']['url'];
						 $tooltipLinkTarget = $item['link']['is_external'] ? ' target="_blank"' : '';
					 } else{
					 ...
					 if ( ! empty( $tooltipText) ) {
						 $tooltip = 'data-toggle="tooltip" data-html="true" data-template=\'<div class="elementor-element elementor-element-'.$instance['id_widget_instance'].' tooltip" role="tooltip"><div class="tooltip-inner tooltip-inner-hotspot"></div></div>\' title="'.$tooltipText.'"';
					 }
					 }
					 ?>
