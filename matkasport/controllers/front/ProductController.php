...
class ProductControllerCore extends ProductPresentingFrontControllerCore
{
    ...
    public function init()
    {
        ...
        $this->context->smarty->assign('filterID', Configuration::getVariableByName('filterCategoryId'));
        $this->context->smarty->assign('categoryToFilterIDS', Configuration::getVariableByName('categoriesToFiltering'));
        if (!Validate::isLoadedObject($this->product)) {
