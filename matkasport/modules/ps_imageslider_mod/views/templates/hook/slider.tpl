...
*}
{if isset($category)}
{assign var="categoryId" value=$category.id|string_format:"%d"}
  ...
  <div class="homeslider-container" data-interval="{$homeslider.speed}" data-wrap="{$homeslider.wrap}" data-pause="{$homeslider.pause}">
    <ul class="rslides">
      {foreach from=$homeslider.slides item=slide}
        {assign var="categoriesSelect" value=","|explode:$slide.category_select}

        {if $categoryId|in_array:$categoriesSelect}
        <li class="slide">
          <a href="{$slide.url}">
