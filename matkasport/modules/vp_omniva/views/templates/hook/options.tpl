...
<div class="panel">
<fieldset>
    <legend>{l s='Free shipping' mod='vp_omniva'}</legend>
    ...
    <div class="margin-form">                                                                                       
        <table cellspacing="0" cellpadding="0" class="table" style="width:28em;">
            <tbody>
                <tr>
                    <th>&nbsp;</th>
                    <th>{l s='ID' mod='vp_omniva'}</th>
                    <th>{l s='Group name' mod='vp_omniva'}</th>
                </tr>
        ...
        <p class="preference_description">
            {l s='Free shipping for checked customer group.' mod='vp_omniva'}
        </p>
    </div>
</fieldset>
</div>
