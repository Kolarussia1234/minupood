...
*}
<div class="panel"><h3><i class="icon-list-ul"></i> {$slot_name}
	<span class="panel-heading-action">
		<a id="desc-product-new" class="list-toolbar-btn" href="{$link->getAdminLink('AdminModules')}&configure=ps_imageslider_home&addSlide=1&slot={$slot_id}">
						...
						<div class="col-md-8">
							...
							<div class="btn-group-action pull-right">
								...
								<a class="btn btn-default"
									href="{$link->getAdminLink('AdminModules')}&configure=ps_imageslider_home&id_slide={$slide.id_slide}">
									<i class="icon-edit"></i>
									{l s='Edit' d='Admin.Actions'}
								</a>
								<a class="btn btn-default"
									href="{$link->getAdminLink('AdminModules')}&configure=ps_imageslider_home&delete_id_slide={$slide.id_slide}">
