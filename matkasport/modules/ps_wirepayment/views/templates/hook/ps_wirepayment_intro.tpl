...
<section>
  <p>
    ...
    {/if}*}
    <img src="/themes/matkasport/assets/img/pangaylekanne@2x.png" style="width: 215px;height: 35px; cursor:pointer;display: block;" onclick="placeOrder()" alt="{l s='Payment by bank wire' d='Modules.Wirepayment.Shop'}" class="bank-wire-payment"/>
  </p>
