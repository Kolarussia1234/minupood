    ...
    {block name='my_account_side_links'}
      ...
      <div class="my-account-side-links col-sm-3">
        ...
        <span class="link-item">
          <i class="user_icon" aria-hidden="true"></i>
          ...
          <span class="link-item">
            <i class="places_icon" aria-hidden="true"></i>
          ...
          <span class="link-item">
            <i class="history_icon" aria-hidden="true"></i>
          ...
          <span class="link-item">
            <i class="price_icon" aria-hidden="true"></i>
          ...
          <span class="link-item">
            <i class="exit_icon" aria-hidden="true"></i>
