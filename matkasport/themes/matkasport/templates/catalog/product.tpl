                ...
                {block name='page_header_container'}
                    ...
                    {/block}
                        ...
                        {block name='product_description_short'}
                            <div id="product-description-short-{$product.id}" class="product_descrip" itemprop="description" class="rte-content">{$product.description_short nofilter}</div>
                        {/block}

                        {block name='product_prices'}
                        {* Product REFERENCE moved from  product-prices.tpl to catalog/_partials/product-details.tpl *}
                    ...
                    <div class="product-actions">
                        {block name='product_buy'}
                            <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
                                ...
                                {/block}
                                {block name='product_stock'}
                                    <div class="warehouses">
                                        {hook h='displayStockInShops' product=$product product_attribute=$product['id_product_attribute']}
                                    </div>
                                {/block}
