    ...
    <div class="iqitsociallogin iqitsociallogin-authentication iqitsociallogin-colors-{$btn_colors} text-center">
        {if $facebook_status}
            <a {if $type}
                ...
                {/if}
               class="btn btn-secondary btn-iqitsociallogin btn-facebook">
        ...
        {if $google_status}
            <a {if $type}
                ...
                {/if}
               class="btn btn-secondary btn-iqitsociallogin btn-google">
        ...
        {if $instagram_status}
            <a {if $type}
               ...
               {/if}
               class="btn btn-secondary btn-iqitsociallogin btn-instagram">
        ...
        {if $twitter_status}
            <a {if $type}
                ...
                {/if}
               class="btn btn-secondary btn-iqitsociallogin btn-twitter">
