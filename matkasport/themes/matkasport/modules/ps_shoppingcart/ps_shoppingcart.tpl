 <div id="blockcart" class="blockcart cart-preview"
        ...
        <a id="cart-toogle" class="cart-toogle header-btn header-cart-btn bag_button" data-toggle="dropdown">
            <i class="bag_icon" aria-hidden="true"><span class="cart-products-count-btn">{$cart.products_count}</span></i>
