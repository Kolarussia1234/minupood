        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <a href="#" onclick="toggle_visibility();" class="close" data-dismiss="modal" aria-label="close">
                        ...
                        <div class="col-md-7">
                            <div class="cart-content">
                                ...
                                <div class="cart-content-btn">
                                    ...
                                    <a href="#" onclick="toggle_visibility();" class="btn btn-secondary btn-block" data-dismiss="modal">{l s='Continue shopping' d='Shop.Theme.Actions'}</a>
                                </div>
                            </div>
                        </div>
                    </div>
